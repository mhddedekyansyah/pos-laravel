@extends('layouts.app', ['title' => 'POS | Customer'])
@section('content')
    <div class="content">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="d-flex justify-content-end mb-3">
                                                <button onclick="addForm(`{{ route('customer.store') }}`)" class="btn btn-primary btn-sm add-category" >Add Customer </button>
                                        </div>
                                        <div class="row">
                                            <div class="col-12">
                                                <form id='form'>
...
@push('scripts')
    ...
    function addForm(url){
        ...
        $('#modal-customer .modal-title').text('Create customer');
        $('#modal-customer form').attr('action', url);
        $('#modal-customer [name=_method]').val('POST');
 ...
 function editForm(urlEdit, urlUpdate){
        $.ajax({
            ...
            success: function(res){
                ...
                $('#modal-customer').modal('show');
                $('#modal-customer .modal-title').text('Edit Customer');
                $('#modal-customer form').attr('action', urlUpdate);
                $('#modal-customer [name=_method]').val('put');
